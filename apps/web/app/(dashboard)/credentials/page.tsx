  ...
  return (
    ...
    <div className='h-full py-6 space-y-8'>
      <Alert>
        ...
        <AlertDescription>
          Your credentials are encrypted using a secure algorithm. Make sure to keep your encryption key safe.
        </AlertDescription>
      </Alert>
    ...
    return (<Card className='w-full p-4'>
      <div className='flex flex-col items-center justify-between p-4 space-x-4'>
        ...
        <div className='flex flex-col gap-1 text-center'>
          ...
          <p className='text-sm text-muted-foreground'>click here to add yours first credentials </p>
        </div>
